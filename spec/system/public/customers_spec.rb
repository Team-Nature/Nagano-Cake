  ...
  describe "about customer page" do
    ...
    context "on customer-show page" do
      ...
      it "has info for customer" do
        ...
        expect(page).to have_content custeomr1.email
      end
    ...
    context "on customer-quit page" do
      ...
      it "has sentences for explaining" do
        expect(page).to have_content "退会すると、会員登録情報やこれまでの購入履歴が閲覧できなくなります。退会する場合は、「退会する」をクリックしてください。"
      end
      it "has button for not quit" do
        expect(page).to have_link "退会しない", href: customer_path
      end
      it "has button for out" do
        expect(page).to have_link "退会する", href: out_path
      end
    ...
    context "on customer-edit page" do
      ...
      it "has table-heading for customer-info" do
        ...
        expect(page).to haev_content "フリガナ"
      ...
      it "has customer-info" do
        ...
        expect(page).to have_field "customer[first_name_kana]", with: custeomr1.first_name_kana
